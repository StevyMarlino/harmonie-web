        ...
        <div class="row row-45">
            <div class="col-sm-6 col-lg-4 wow fadeInLeft">
                ...
                <article class="post post-modern"><a class="post-modern-figure" href="#"><img
                            src="{{ asset('vitrine/images/post-10-370x307.jpg') }}" alt="" width="370"
                            height="307" />
                    ...
                    <p class="post-modern-text">Asynchronous functions are a good and bad thing in JavaScript. The good
                        side is that asynchronous functions are non-blocking and...</p>
                </article>
            </div>
            <div class="col-sm-6 col-lg-4 wow fadeInLeft" data-wow-delay=".1s">
                <!-- Post Modern-->
                <article class="post post-modern"><a class="post-modern-figure" href="#"><img
                            src="{{ asset('vitrine/images/post-11-370x307.jpg') }}" alt="" width="370"
                            height="307" />
                        <div class="post-modern-time">
                    ...
                    <p class="post-modern-text">Digital transformation requires cloud appropriate adoption, legacy IT
                        systems modernization, and Agile-based methodologies for faster...</p>
                </article>
            </div>
            <div class="col-sm-6 col-lg-4 wow fadeInLeft" data-wow-delay=".2s">
                <!-- Post Modern-->
                <article class="post post-modern"><a class="post-modern-figure" href="#"><img
                            src="{{ asset('vitrine/images/post-12-370x307.jpg') }}" alt="" width="370"
                            height="307" />
                        <div class="post-modern-time">
                    ...
                    <p class="post-modern-text">In this tutorial, we will discuss the Hibernate Query Language. HQL is
                        an object-oriented query language. Hibernate Query...</p>
                </article>
            </div>
        </div>
    </div>
