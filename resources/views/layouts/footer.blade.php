                ...
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="d-md-flex">
                        <ul class="list-unstyled w-100">
                            ...
                            <li><a href="#"><span
                                        class="ion ion-ios-arrow-round-forward me-2"></span>Organisation</a></li>
                            <li><a href="#"><span class="ion ion-ios-arrow-round-forward me-2"></span>Publications</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon fa fa-map marker"></span><span class="text">Localisation : Gabon, Libreville</span></li>
                ...
                <div class="col-md-12 text-center">
                    <p class="mb-0" style="font-size: 14px;">Copyright &copy;
                        <script>
                            ...
                            href="#" target="_blank" rel="nofollow noopener">SM</a>
                    </p>
                </div>
            </div>
        </div>
