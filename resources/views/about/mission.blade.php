        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-end justify-content-center">
                <div class="col-md-9 text-center mb-5">
                    <p class="breadcrumbs"><span class="me-2"><a href="{{ route('home') }}">Accueil 
                                <i class="fa fa-chevron-right"></i></a></span> <span>Mission <i class="fa fa-chevron-right"></i></span></p>
                    <h1 class="mb-0 bread">Nos Missions</h1>
                </div>
            </div>
        </div>
    </section>
    <section class="ftco-section">
        <div class="container">
            <div class="row g-lg-5">
                <div class="col-lg-8">
                    <p>
                        <img src="{{ asset('images/justice.webp') }}" alt="" class="img-fluid">
                    </p>
